                    ...
                    <Col lg={7} md={10} sm={12} className="p-5 m-auto shadow-sm rounded-lg">
                        <Form onSubmit={handleSubmit(onSubmit)} >
                            <Form.Group className="mb-3" controlId="tutorialNumber">
                                ...
                                <Form.Control defaultValue={tutorial.number} {...register("number",  {required: {value:true, message:"*번호를 입력하세요"} , pattern: {value: /^[0-9]+$/, message:"*번호는 숫자만 가능합니다"}})} />
                            ...
                            <Form.Group className="mb-3" controlId="tutorialTitle">
                                ...
                                <Form.Control type="title" defaultValue={tutorial.name} {...register("name",  {required: {value:true, message:"*제목를 입력하세요"}})} />
